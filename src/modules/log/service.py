...
from src.modules.log.dto import SqlGeneratorLogRequestModel, SqlExecutorLogRequestModel
...
# sql executor log 저장 함수
def save_sql_executor_log (db_log : SqlExecutorLogRequestModel):
    db = get_db_internal()
