...
class SqlGeneratorLogRequestModel(Base):
    ...
    pre_llm_filter_status: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
...
class SqlExecutorLogRequestModel(Base):
    ...
    pre_sql_filter_complete_timestamp: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
    post_sql_filter_complete_timestamp: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
